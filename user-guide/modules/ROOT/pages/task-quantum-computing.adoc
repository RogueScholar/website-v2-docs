...
Unlike a classical random walk (which results in a bell curve), quantum walks create dominant peaks due to constructive and destructive interference:

image::quantum-walk-one.png[one-dimensional quantum walk]
...
image::quantum-walk-two.png[two-dimensional quantum walk]
...
Again, the result shows the probability distribution of being at any one of the positions at the end of the 2D walk. The following image shows the distribution, after 100 steps, with visual clarity - a rich structured probability distribution with high-probability regions at specific positions, not just a spreading blur:

image::quantum-walk-two-100.png[quantum walk in 2D]
